...
class MlflowAzureMLHook:
    ...
    def after_context_created(self, context) -> None:
        ...
        if experiment_name:
            ...
            logger.info(
                "kedro-azure-ml: set MLFLOW_EXPERIMENT_NAME=%s", experiment_name
            )
    ...
    def before_pipeline_run(self, run_params, pipeline, catalog) -> None:
        ...
        try:
            ...
            logger.warning(
                "kedro-azure-ml: mlflow is not installed, skipping run tagging"
            )
            return
        ...
        if node_name:
            ...
            mlflow.MlflowClient().set_tag(
                active_run.info.run_id, "mlflow.runName", child_run_name
            )

...
Kedro AzureML Pipeline is built on a hardened, security-first release pipeline. This page
...
[security policy](https://github.com/stateful-y/kedro-azureml-pipeline/security/policy)

...
- **Feature parity** - Azure ML's pipeline model and Kedro's pipeline model do not overlap perfectly. Some advanced Azure ML features (conditional branching, pipeline parameters with complex types) may require workarounds.

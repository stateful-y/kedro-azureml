...
- [**Job Factories**](job-factories.md): Why a family of similar jobs is expressed as one templated entry, the dataset-factory analogy, and when to reach for a factory over explicit jobs.
